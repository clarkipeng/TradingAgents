...
def test_formal_experiment_identities_remain_frozen() -> None:
    assert GLOBAL_EVENT_V2_COLLECTION_PROTOCOL_ID == "protocol_b19d2d7e9a3bdc6bd398d66c"
    assert GLOBAL_EVENT_V2_COLLECTOR_SEMANTICS_ID == "collector_f4ed952ec4c96058c0e7d5a8"
